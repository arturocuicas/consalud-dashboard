...
var chartData = [
	...
	distanceAxis.title = "licencias";
	distanceAxis.gridAlpha = 0;
	distanceAxis.axisAlpha = 0;
	chart.addValueAxis(distanceAxis);

	// renata_a value axis
	var renata_aAxis = new AmCharts.ValueAxis();
	renata_aAxis.gridAlpha = 0;
	renata_aAxis.axisAlpha = 0;
	renata_aAxis.labelsEnabled = false;
	renata_aAxis.position = "right";
	chart.addValueAxis(renata_aAxis);


// renata_a value axis
	var renata_bAxis = new AmCharts.ValueAxis();
	renata_bAxis.gridAlpha = 0;
	renata_bAxis.axisAlpha = 0;
	renata_bAxis.labelsEnabled = false;
	renata_bAxis.position = "right";
	chart.addValueAxis(renata_bAxis);

	// duration value axis
	// var durationAxis = new AmCharts.ValueAxis();
	// durationAxis.title = "Rentas Alta";
	...
	distanceGraph.valueField = "licencias";
	distanceGraph.title = "licencias";
	...
	// renata_a graph
	var renata_aGraph = new AmCharts.AmGraph();
	renata_aGraph.valueField = "renata_a";
	renata_aGraph.title = "renata_a";
	renata_aGraph.type = "line";
	renata_aGraph.valueAxis = renata_aAxis; // indicate which axis should be used
	renata_aGraph.lineColor = "#0000ff";
	renata_aGraph.lineThickness = 1;
	renata_aGraph.legendValueText = "[[value]]";
	renata_aGraph.descriptionField = "townName";
	renata_aGraph.bullet = "round";
	renata_aGraph.bulletSizeField = "townSize"; // indicate which field should be used for bullet size
	renata_aGraph.bulletBorderColor = "#786c56";
	renata_aGraph.bulletBorderAlpha = 1;
	renata_aGraph.bulletBorderThickness = 2;
	renata_aGraph.bulletColor = "#000000";
	renata_aGraph.labelText = "[[townName2]]"; // not all data points has townName2 specified, that's why labels are displayed only near some of the bullets.
	renata_aGraph.labelPosition = "right";
	renata_aGraph.balloonText = "renata_a:[[value]]";
	renata_aGraph.showBalloon = true;
	renata_aGraph.dashLengthField = "dashLength";
	chart.addGraph(renata_aGraph);

	// renata_a graph
	var renata_bGraph = new AmCharts.AmGraph();
	renata_bGraph.valueField = "";
	renata_bGraph.title = "";
	renata_bGraph.type = "line";
	renata_bGraph.valueAxis = renata_bAxis; // indicate which axis should be used
	renata_bGraph.lineColor = "#ff0000";
	renata_bGraph.lineThickness = 1;
	renata_bGraph.legendValueText = "[[description]]/[[value]]";
	renata_bGraph.descriptionField = "townName";
	renata_bGraph.bullet = "round";
	renata_bGraph.bulletSizeField = "townSize"; // indicate which field should be used for bullet size
	renata_bGraph.bulletBorderColor = "#786c56";
	renata_bGraph.bulletBorderAlpha = 1;
	renata_bGraph.bulletBorderThickness = 2;
	renata_bGraph.bulletColor = "#000000";
	renata_bGraph.labelText = "[[townName2]]"; // not all data points has townName2 specified, that's why labels are displayed only near some of the bullets.
	renata_bGraph.labelPosition = "right";
	renata_bGraph.balloonText = "renata_b:[[value]]";
	renata_bGraph.showBalloon = true;
	renata_bGraph.dashLengthField = "dashLength";
...
function DrawAllCharts(){
	...
	var chart1_options = {
		...
		vAxis: {title: 'Numero', titleTextStyle: {color: 'blue'}}
	};
	...
	var chart1a_element = 'google-chart-1a';
	var chart1a_type = google.visualization.ColumnChart;
	drawGoogleChart(chart1a_data, chart1a_options, chart1a_element, chart1a_type);
	//  Chart 2
	var chart2_data = [
		['Height', 'Width'],
		['No Fraude',  3],
...
function MorrisDashboard(){
	...
	Morris.Donut({
		...
		data: [
			{value: 70, label: '45 años', formatted: 'Prom. Fraude' },
			{value: 30, label: '45 años', formatted: '' }
		],
	...
	Morris.Donut({
		...
		data: [
			{value: 70, label: '35 años', formatted: 'Prom. No Fraude' },
			{value: 30, label: '35 años', formatted: '' }
		],
		formatter: function (x, data) { return data.formatted; }
	});
	Morris.Donut({
